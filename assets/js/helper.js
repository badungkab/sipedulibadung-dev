...
const API_URL = 'https://script.google.com/macros/s/AKfycbw5eYllybUioYJUpOJoGB6i7rwQsefYISpjsPs2cnFOH9CIrLHMqy1Dd9_n2XLxkWjJpQ/exec';
...
async function createUser(data) {
    return await apiPost('createUser', data);
}

async function changePassword(data) {
    return await apiPost('changePassword', data);
}
